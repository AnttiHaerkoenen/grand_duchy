...
if __name__ == '__main__':
    ...
    print(f"1760-1780: \n {get_closest_words(model_1760, 'nation'.split(), 10)}")
    print(f"1780-1800: \n {get_closest_words(model_1780, 'nation'.split(), 10)}")
    print(f"1800-1820: \n {get_closest_words(model_1800, 'nation'.split(), 10)}")
    print(f"1820-1840: \n {get_closest_words(model_1820, 'nation'.split(), 10)}")
    print(f"1840-1860: \n {get_closest_words(model_1840, 'nation'.split(), 10)}")
    print(f"1860-1880: \n {get_closest_words(model_1860, 'nation'.split(), 10)}")
    print(f"1880-1900: \n {get_closest_words(model_1880, 'nation'.split(), 10)}")
    print(f"1900-1920: \n {get_closest_words(model_1900, 'nation'.split(), 10)}")
